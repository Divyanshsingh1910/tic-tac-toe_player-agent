...
# changes - (Arush) changed the paths to relative path
def choose_image_0():
        folder_0 = r'Data\Modified_Images\zeros'
        files_0 = os.listdir(r'Data\Modified_Images\zeros')
...
def choose_image_1():
        ...
        files_1 = os.listdir(r'Data\Modified_Images\crosses')
